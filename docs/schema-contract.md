...
| `fixtures/warnings/unknown-provider`     | Valid custom provider plus a missing provider thread reference.                      | `W100`, `W120`.                                                                |
| `fixtures/warnings/active-check-overdue` | Active run with past check time relative to the fixture clock.                       | `W111`.                                                                        |
| `fixtures/warnings/index-missing-link`   | Valid run omitted from dashboard with a body `Next Action` mismatch.                 | `W130`, `W150`.                                                                |
