...
| `fixtures/warnings/unknown-provider`     | Valid custom provider value plus a missing provider thread reference.                | `W100`, `W120`.                                                                |
| `fixtures/warnings/active-check-overdue` | Active run with an overdue `check`.                                                  | `W111`.                                                                        |
| `fixtures/warnings/index-missing-link`   | Valid run omitted from `agents/index.md` with a mismatched body `Next Action`.       | `W130`, `W150`.                                                                |
